...
#     await interaction.response.defer(ephemeral=True)  # 🔧 Immediate response
...
#             if self.disabled:
#                 return await interaction.response.send_message("⚠️ Duel already accepted/rejected.", ephemeral=True)
